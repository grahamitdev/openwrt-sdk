 ...
 * @note None.
 */
void plaform_flash_program_start(void);
 ...
 * @note None.
 */
typedef int (*platform_awss_recv_80211_frame_cb_t)(char *buf, int length, int link_type, int with_fcs);
